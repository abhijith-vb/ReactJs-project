...
const EditableRow = ({editFormData,handleEditFormChange}) => {
    return (
        <tr>
            ...
            value={editFormData.email} onChange={handleEditFormChange}></input>
            </td>
            <td>
            <input type="text" name="phone" required="required" placeholder="Enter Name"
            value={editFormData.phone} onChange={handleEditFormChange}></input>
            </td>
            <td>
